...
uint256 hashGenesisBlock("0xa1949277bcd8cf33c8344e86cc6898d96587b99e972283eaffd50b7f48dcf7df");
...
{
    int64 nSubsidy = 1.23456789 * COIN;
    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 0.0011574 * 24 * 60 * 60; // Asscoin: every 100 sec
static const int64 nTargetSpacing = 10; // Asscoin: 15 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal Asscoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Asscoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xa1949277bcd8cf33c8344e86cc6898d96587b99e972283eaffd50b7f48dcf7df");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "Asad was born";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x698af6608ab695445691bbf8eb900f38f40ea47d18bc6741ed2a7f6475dbe388"));
